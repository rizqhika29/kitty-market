...
async function main() {
  ...
  // Create second account for creator (can't bet on own market)
  ...
  // ========== WRITE: COLLECT FEES (should fail - not owner of correct type) ==========
  console.log("\n========== WRITE: COLLECT FEES ==========");
  await writeAndWait("collect_fees (expect fail - zero balance)", () => client2.writeContract({
